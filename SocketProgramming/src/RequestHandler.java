...
public class RequestHandler {
    ...
    public void handleRequest(Socket clientSocket) throws Exception{
        Runnable task = () -> {
            try (// Get the input and output streams for reading and writing data to the client
            BufferedReader in = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()))) {
                ...
                throw new RuntimeException("Error communicating with the client", e);
            }
        };
    }
}
